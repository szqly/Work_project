...
//    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        File file=new File("C:\\Users\\Faith\\IdeaProjects\\Work3\\src\\main\\webapp\\img");
        ...
        while(true){
            ...
            if(str.startsWith(startBoundary)){
                ...
                if(position1 == -1){//表示是普通文本域上传
                    ...
                    String path = "C:/Users/Faith/IdeaProjects/Work3/src/main/webapp/img";
                    DataOutputStream dOutputStream = new DataOutputStream(new FileOutputStream(new File(path + "/"+(files.length+1)+".png")));
                    ServletConfig config = getServletConfig();
                    ServletContext context = config.getServletContext();
                    context.setAttribute("imgnof",files.length+1);
