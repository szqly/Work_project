...
<a><%=context.getAttribute("name")%></a>
<a href="http://localhost:9999/Work_war_exploded/">退出</a>
...
<%--                <td id="<%=student.getId()%>"><%=student.getId()%></td>--%>
    ...
    <div id="box2">
        <div class="Title">
            新增课程
            <a href="http://localhost:9999/Work_war_exploded/JSP/main.jsp" id="close" onclick="closes();">关闭</a>
        </div>
        <a class="typea">课程名</a>
