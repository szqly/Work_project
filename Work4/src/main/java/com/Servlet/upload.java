...
//    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        File file=new File("C:\\Users\\Faith\\IdeaProjects\\Work4\\src\\main\\webapp\\img");
        ...
        while(true){
            ...
            if(str.startsWith(startBoundary)){
                ...
                if(position1 == -1){//表示是普通文本域上传
                    ...
                    String path = "C:/Users/Faith/IdeaProjects/Work4/src/main/webapp/img";
                    ...
                    context.setAttribute("imgno",files.length+1);
